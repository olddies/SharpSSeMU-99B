...
(`tools/protogen/`). Do not edit them by hand or transcribe layouts: alignment
padding travels on the wire and is easy to get wrong. Before treating unported
client code as a bug, confirm the feature exists in real 0.99B (the original
client's `Data/Interface`) — this codebase contains many Season 6 features.
