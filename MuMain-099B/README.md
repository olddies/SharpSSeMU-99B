# MuMain-099B — a MuMain fork for MU Online 0.99B

*(Below: the upstream MuMain project description, kept for attribution and build notes.)*
...
**Upstream project description (sven-n/MuMain) follows.**
