...
/// <summary> Port with FULL coverage of <c>GameServerInfo - Character.dat</c> (part of <c>CServerInfo</c>,
...
/// consumer already ported), this class loads ALL 155 fields of this file (239 .ini keys, some are arrays per
