...
/// <summary> Port with FULL coverage of <c>GameServerInfo - Common.dat</c> (part of <c>CServerInfo</c>,
...
/// consumer already ported), this class loads ALL 132 fields of this file (202 .ini keys, some are arrays per
